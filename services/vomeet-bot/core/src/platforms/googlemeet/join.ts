...
import { callJoiningCallback, log, randomDelay } from "../../utils";
import {
...
export async function joinGoogleMeeting(
	...
	await page.screenshot({
		path: "/app/storage/screenshots/bot-checkpoint-0-name-field-found.png",
		fullPage: true,
	});
	...
	await page.screenshot({
		path: "/app/storage/screenshots/bot-checkpoint-0-after-ask-to-join.png",
		fullPage: true,
	});
